[![CI/CD GitHub Actions](https://github.com/Spooneater/gtest/actions/workflows/test-action.yml/badge.svg)](https://github.com/Spooneater/gtest/actions/workflows/test-action.yml)
